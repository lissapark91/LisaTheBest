...
// 	paramMap.put(searchType, searchWord);
...
<body>
	<div class="container">
		...
		<!-- 검색폼 -->
		<form class="form-inline" name="searchForm" action="memberList" method="get">
...
<%-- 				<option value="name" ${param.searchType == 'name' ? 'selected' : '' }>이름</option> --%>
		...
		<p align="right"><input class="btn-default" type="button" value="회원 가입" onclick="fn_form()"></p>
