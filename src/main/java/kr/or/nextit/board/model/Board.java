...
public class Board {
	...
	public void setBo_writer(String bo_writer) {
		...
		setBo_writer_sec(this.bo_writer);
	}
	...
	public String getBo_writer_sec() {
		bo_writer_sec = bo_writer_sec.substring(0 , 4);
		bo_writer_sec += "****";
		return bo_writer_sec;
	}
	public void setBo_writer_sec(String bo_writer_sec) {
		this.bo_writer_sec = bo_writer_sec;
	}
